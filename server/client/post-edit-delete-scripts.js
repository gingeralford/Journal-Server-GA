...
function editJournal(postId) {
    ...
    if(card.childNodes.length < 2) {
        ...
        //replaces info in the journal entry JSON, only have update certain key-value pairs in that whole JSON
        const response = fetch(fetch_url, {
            ...
            //need the accessToken because this is for a certain person's entry, route is autheticated
